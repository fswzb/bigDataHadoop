...
public class HBaseTopology extends BaseTopology
{
	//Topology components IDs
	private static final String HBASE_UPDATE_BOLT_ID = "HBaseUpdateBolt";
    ...
    public HBaseTopology(String configFileLocation) throws Exception 
    {
